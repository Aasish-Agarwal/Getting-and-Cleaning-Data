...
```{r, echo=TRUE}
library(tidyr)
ds1 <- gather(dataset,variable,value, -subject, -activity)
...
ds1 <- mutate(ds1, domain = sapply(variable, getDomain) , 
...
ds2 <- group_by(ds1,variable,domain,signal,feature,axis,valuetype)
ds2 <-summarize(ds2,meanvalue = mean(value), count = n())
ds2
